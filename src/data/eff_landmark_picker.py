...
def elp(save_data, num_timepoints):
    ...
    # Settings
        ...
        class MainWindow():
            ...
            def __init__(self, main):
                ...
                self.button_quit = tk.Button(self.main, text="Quit", fg="black", command=root.quit)
            ...
            def add_image_directory(self):
                ...
                for tp in range(num_timepoints):
                    ...
                    self.im_dir_list.append(self.im_dir)
        ...
        class image_window():
            ...
            def __init__(self, timepoint, main, position, im_directory):
                ...
                #TODO figure out how to move slider to bottom of window
                self.z_slider.pack()
        ...
        if os.path.isfile(filename):
            return_statement = "Path to excel file with landmarks: {}".format(filename)
        else:
            return_statement = "Excel file with landmakrs not found here: {}".format(filename)
